...
ML.dta %>% 
  ...
  geom_point(size=0.05, shape = ".", alpha = 0.05, fill = "darkolivegreen3", color = "black") +
...
preds = c("perind" = "% Native American",
                             ...
                             "perell"= "% English Language Learners",
                             "perspeced"= "% Studnets in Special Ed.",
                             "totenrl"= "# Students Enrolled in District", 
                             "sesavgall"= "SES Score", 
                             "lninc50avgall"= "Log  Median Income",
                             "baplusavgall"= "% Adults in District w/ BA degree", 
                             "povertyavgall"= "Poverty Rate (%)",
                             "unempavgall"= "Unemployment (%)",
                             "snapavgall"= "SNAP Rate (%)",
                             "single_momavgall" = "% Students w/ Single Mom",
                             "ppexp_tot" = "Expenditure Per Pupil (USD)",
