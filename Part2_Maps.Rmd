...
![How Gerrymadering Manipulates District Boundaries](Part2_Image.png){width=75% height=75%}
...
ideology <- read.csv('Part2_PoliticalIdeology.csv')
...
For the following code, please ensure that you have the Stanford Education Data Archive *district by year by grade covariates from acs and ccd master_v1_1.dta* installed and available in your working directory

- These data are available for download from [ttps://exhibits.stanford.edu/data/catalog/db586ns4974](https://exhibits.stanford.edu/data/catalog/db586ns4974)
- **Please note:** To run the remaining file, you will need to separately download the file, named `district by year by grade covariates from acs and ccd master_v1_1.dta` available in the online repository, or similarly [clicking this link](https://stacks.stanford.edu/file/druid:db586ns4974/district%20by%20year%20by%20grade%20covariates%20from%20acs%20and%20ccd%20master_v1_1.dta)
- These data must be housed within the same folder, or working directory, as this file
